...
const swaggerOptions = {
    definition: {
        ...
        servers: [
            {
                url: `http://31.97.110.107:${port}/api`,
...
app.listen(port, () => {
    console.log(`Server is running on http:31.97.110.107:${port}`);
    console.log(`Swagger documentation available at http://31.97.110.107:${port}/docs`);
});
